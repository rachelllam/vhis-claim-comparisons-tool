...
export const CASES: SurgeryCase[] = [
  // Minor
...
export const getTreatmentDetail = (en: string): TreatmentDetail | null => TREATMENT_DETAILS[en] || null;
...
export function repCasesByTier(): { tier: SurgeryTier; caseItem: SurgeryCase }[] {
...
export const repCaseIdsByTier = (): string[] => repCasesByTier().map((r) => r.caseItem.en);
...
export function casesFromIds(ids: string[]): SurgeryCase[] {
